...
public class gestClient {
    ...
    private static List<Cliente> conjClientes;
    ...
    public static boolean deleteClient(Cliente cliente) {
    ...
    public static void changeTarifa( Cliente cliente, Tarifa tarifa ){
    ...
    public static Cliente searchClient ( String nif ) {
